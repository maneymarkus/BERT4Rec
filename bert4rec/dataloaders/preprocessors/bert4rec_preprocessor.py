...
class BERT4RecPreprocessor(BasePreprocessor):
    ...
    @classmethod
    def process_element(cls, sequence) -> dict:
        """
    ...
    def prepare_inference(cls, data) -> dict:
        ...
        preprocessed_sequence = cls.process_element(sequence)
    ...
    @classmethod
    def _call_process_element(cls, sequence):
        """
        ...
        """
        model_inputs = cls.process_element(sequence)
