...
def main():
    ...
    dataloader = dataloader_factory.create_beauty_dataloader(**dataloader_config)
    dataloader.generate_vocab()
    train_ds, val_ds, test_ds = dataloader.prepare_training()
    tokenizer = dataloader.get_tokenizer()

    # load a specific config
    config_path = pathlib.Path("../bert4rec/config/bert4rec_train_configs/beauty_64.json")
    ...
    save_path = model_utils.determine_model_path(pathlib.Path("bert4rec_beauty_2"))
