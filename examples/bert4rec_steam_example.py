...
def main():
    ...
    dataloader_config = {
        "input_duplication_factor": 2
    }
    dataloader = dataloader_factory.create_steam_dataloader(**dataloader_config)
    ...
    save_path = model_utils.determine_model_path(pathlib.Path("bert4rec_steam"))
